...
2. **Assumption:** Gli atleti seguano l'ordine dei blocchi strutturati nel workout, salvo deviazioni impreviste gestite dall'algoritmo.   
...
7. **Risk (Organizzativo):** Rallentamenti nello sviluppo causati dall'abbandono di un membro del team (Bus Factor).
...
11. **Obstacle:** Vincolo temporale di 8 mesi per il rilascio dell'MVP, comprensivo del protocollo di validazione (Lab e Field Testing).