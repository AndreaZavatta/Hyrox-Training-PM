...
L'esecuzione del lavoro non è divisa in pacchetti statici (WBS/WP), ma in **Sprints di 2 settimane**. Le regole del team impongono un focus assoluto sulla consegna di software funzionante e sulla risoluzione empirica dei problemi.
