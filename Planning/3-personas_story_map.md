...
*   **Fase 5: Sincronizzazione Dati:** I dati della sessione fluiscono in modo sincrono/asincrono dal watch allo smartphone e poi al database cloud.
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| **RELEASE 1<br>Foundation (MVP)**<br>*Sprints 1-3*<br>*(Effort: 26 SP)* | **US-TEC-01** (Setup CI/CD/Repo)<br>**US-TEC-02** (Architettura DB/API)<br>**US-D-01** (Autenticazione e ACL)<br>**US-D-02** (Profilo & Categoria) | **US-D-06** (Workout Builder) | - | - | - | - |
...
*   **Perché la Release 1 si concentra su Configurazione e Creazione?**  
    Roberto (il Coach) deve poter definire la struttura del workout tramite il builder (Fase 2) prima che l'atleta possa sincronizzarla o tracciarla. Inoltre, senza la profilazione delle soglie cardiache e delle categorie di Marco (Fase 1), i calcoli di intensità e pesistica non avrebbero un benchmark di riferimento.
