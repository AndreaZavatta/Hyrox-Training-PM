...
### EPIC 1: Sottosistema Smartwatch (Wearable) [Totale: 55 SP]
...
*   **Feature 1.4: Caching & Persistenza Dati [8 SP]**
    *   **US-W-05 (Caching Locale - Offline-First) [8 SP] (SHOULD):** Memorizzazione locale continua dei dati biometrici e di movimento per prevenire perdite di dati in caso di disconnessione.
...
### EPIC 3: Sottosistema Sincronizzazione Dati [Totale: 18 SP]
...
*   **Feature 3.2: API Cloud Sync [5 SP]**
    *   **US-S-02 (Sincronizzazione Phone -> Cloud) [5 SP] (MUST):** Upload del workout dallo smartphone al server cloud per l'aggiornamento immediato della Dashboard.
...
### EPIC 4: Inizializzazione Tecnica & Gestione Agile [Totale: 10 SP]
...
*   **Feature 4.2: Data Modeling Core [5 SP]**
    *   **US-TEC-02 (Progettazione Modello Dati e API Core) [5 SP] (MUST):** Definizione dello schema database e dei contratti API per garantire la coerenza dei dati tra i sottosistemi.
...
2.  **Pianificazione degli Sprint (Velocity):** Con una Velocity stimata del team pari a circa **8-10 Story Points per Sprint**, il backlog complessivo di **128 SP** è schedulato per essere sviluppato in circa 13 Sprint di puro sviluppo, lasciando i restanti Sprint per la validazione sul campo (SUS, Lab Testing) e il rilascio finale.
